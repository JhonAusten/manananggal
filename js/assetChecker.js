...
const assetChecker = {
    assets: {
        ...
        'Character Death': 'assets/images/characters/character-death.png',
        'Manananggal': 'assets/images/monsters/manananggal.png',
        'Machete': 'assets/images/weapons/machete.png',
        'Sword Wave': 'assets/images/weapons/sword-wave.png',
        ...
        'Wave Buff': 'assets/images/ui/wave-buff.png'
    },
    ...
    updateDebugInfo(status, loadedCount = null, totalAssets = null) {
        ...
        if (debugElement) {
            ...
            statusText += Object.entries(status)
                .map(([name, loaded]) => {
                    const shortName = name.replace(/^(Character|Manananggal|Machete|Background|HUD|Power|Wave|UI|Sword)\s*/i, '');
